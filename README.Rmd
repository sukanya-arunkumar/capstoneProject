...
The goal of this project is to analyze taxi fares logs to be able to predict a trip's fare knowing the pickup location, the drop off location, the date and the time of the ride. In addition to that, we could compare the yellow taxi fares to the green taxi fares and see how or if the limitations of the green taxi affect their fares. It would also be interesting to check the fare changes compared to certain events (subway strikes, holidays, new private taxi companies like uber or lyft, weekdays vs weekends)
...
* Build a regression graph matrix (if needed, go back to the clean phase)
